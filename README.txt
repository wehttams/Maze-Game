...
- The game has animation and is interactive because there is player-controlled movement
...
- The physical mechanism is the motion of the player
- There is collision detection when you hit a wall or hit the end goal
- The flourish is sound effects: when you hit a wall, when you win, when you lose, and when you start up the game
...
Matt Fortes (NetID: mfortes3)
Richard Chuong (NetID: rchuong)
Alan Jimenez (NetID: ajimen11)